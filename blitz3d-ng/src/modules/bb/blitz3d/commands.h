...
void BBCALL bbTextureBumpEnvMat( Texture *texture,bb_int_t x,bb_int_t y,bb_float_t envmat );
void BBCALL bbTextureBumpEnvScale( Texture *texture,bb_float_t envscale );
void BBCALL bbTextureBumpEnvOffset( Texture *texture,bb_float_t envoffset );
